	...
	<div class="col-xs-12 col-md-6">
		<p class="payment_module" id="wxpay_payment_button">
			{if $cart->getOrderTotal() < 2}
				<a href="">
					<img src="{$domain|cat:$payment_button|escape:'html':'UTF-8'}" alt="{l s='Pay with my payment module' mod='wxpay'}" />
					{l s='Minimum amount required in order to pay with my payment module:' mod='wxpay'} {convertPrice price=2}
				</a>
			{else}
