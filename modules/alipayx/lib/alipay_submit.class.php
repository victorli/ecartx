...
class AlipaySubmit {
	...
	public function createUrl($params,$gateway = false)
    {
        $params_url = $this->buildRequestPara($params);
        $params_url = $this->getPaymentUrlParam($params_url);
        if ($gateway == false) {
            $url = $this->alipay_gateway_new.$params_url;
        } else {
