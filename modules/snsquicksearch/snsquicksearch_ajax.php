...
include_once('snsquicksearch.php');

$context = Context::getContext();
$wp_search = new SnsQuickSearch();
...
$query = urldecode(Tools::getValue('q'));
    if ($ajax_search){
        ...
        foreach ($searchResults as &$product){
            ...
            $product['product_image'] = $context->link->getImageLink($product['prewrite'], $cover['id_image'], 'cart_default');
        }
