{if $instantsearch && $page_name != 'index'}
...
{if $ajaxsearch}
    <script type="text/javascript">
        ...
        $('document').ready(function() {
            $("#search_query_{$blocksearch_type}").autocompleteCustom(moduleDir + "snsquicksearch_ajax.php", {
            	container: $("#search_block_{$blocksearch_type}"),
                minChars: 3,
                max: 9,
                width: 300,
                selectFirst: false,
                ...
                parse: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (i == 5) {
                            ...
                            mytab[mytab.length] = { data: data[i], value: '<span class="ac_more_link button">{l s='More Results...' mod='snsquicksearch'}</span>' };
