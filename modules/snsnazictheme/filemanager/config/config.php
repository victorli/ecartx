...
if (!defined('_PS_ROOT_DIR_'))
	define('_PS_ROOT_DIR_', dirname(dirname(dirname(dirname(dirname(__FILE__))))) );

if(isset($_REQUEST['ad_basename']))
	$ad_basename = strip_tags(preg_replace("/[^a-zA-Z0-9\.\[\]_| -]/", '', $_REQUEST['ad_basename']));
else die();

if (!defined('_PS_ADMIN_DIR_'))
		define('_PS_ADMIN_DIR_', _PS_ROOT_DIR_.'/'.$ad_basename.'/');
...
$upload_dir = __PS_BASE_URI__.'themes/sns_nazic/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = _PS_ROOT_DIR_.'/themes/sns_nazic/images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = _PS_ROOT_DIR_.'/themes/sns_nazic/tmp/images/'; // relative path from filemanager folder to thumbs folder (with final /)
