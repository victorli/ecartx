...
<!-- MODULE MailAlerts -->
	{if isset($email) AND $email}
		<p class="form-group">
			<input type="text" id="oos_customer_email" name="customer_email" placeholder="{l s='Enter your email' mod='mailalerts'}" value="" class="mailalerts_oos_email form-control" />
    	</p>
    {/if}
