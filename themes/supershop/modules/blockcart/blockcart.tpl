...
{/if}
	<div class="shopping_cart">
        ...
        <a class="visible-xs" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" style="position: absolute;top: 0;left: 0;width: 100%; height: 100%;" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">&nbsp;</a>
		{if !$PS_CATALOG_MODE}
										...
										<div class="cart-info pull-left">
											...
											<span class="price">
												...
												<div style="width: 150px" class="change_quantity">
												  <a onclick="blockcartDownQuantity('{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}', '')" class="blockcart_quantity_down" 
												  id="blockcart_quantity_down_{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}" 
												  href="javascript:void(0)" rel="nofollow" title="{l s='Subtract'}"><i class="icon-minus"></i></a>
												  <input type="hidden" name="quantity_{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}_hidden" value="{$product.cart_quantity}" class="cart_quantity_input_text" />
												  <input type="text" name="quantity_{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}" class="cart_quantity_input_text" value="{$product.cart_quantity}">
												  <a onclick="blockcartUpQuantity('{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}', '')" class="blockcart_quantity_up" 
												  id="blockcart_quantity_up_{$product.id_product}_{if $product.id_product_attribute}{$product.id_product_attribute}{else}0{/if}_{if isset($id_customization)}{$id_customization|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery}{else}0{/if}"	
