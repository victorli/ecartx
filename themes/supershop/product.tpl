	...
	<div class="primary_block row">
		...
		<div class="pb-center-column col-xs-12 col-sm-7">
			...
			<section class="page-product-box">
				<h3 class="page-product-heading" style="font-size: 14px; font-weight: bold">{l s='Attachments'}: </h3>
				{foreach from=$attachments item=attachment name=attachements}
					{if $smarty.foreach.attachements.iteration %3 == 1}<div class="row">{/if}
						<div class="col-lg-12">
							<div>{$attachment.name|escape:'html':'UTF-8'} <small>({Tools::formatBytes($attachment.file_size, 2)})</small> - <a href="{$link->getPageLink('attachment', true, NULL, "id_attachment={$attachment.id_attachment}")|escape:'html':'UTF-8'}">{l s="Download"}</a></div>
							<p class="text-muted" style="font-style: italic">{$attachment.description|escape:'html':'UTF-8'}</p>
							<!--
...
<div class="row">
     <div id="tab-container" class="col-xs-12">
        ...
        <ul id="product-tabs" class="nav nav-tabs" role="tablist">
            {if isset($product) && $product->description}
                <li><a href="#descripntion-tab" role="tab" data-toggle="tab">{l s='Product Details'}</a></li>{/if}
            {if isset($features) && $features}
                <li><a href="#table-data-sheet" role="tab" data-toggle="tab">{l s='Information'}</a></li>{/if}
            {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
                <li><a href="#quantityDiscount-tab" role="tab" data-toggle="tab">{l s='Discounts'}</a></li>{/if}
            {if $HOOK_PRODUCT_TAB}
                {$HOOK_PRODUCT_TAB}
            {/if}
        </ul>
	...
	<!--Customization -->
	<section class="page-product-box">
		<h3 class="productscategory_h3 page-product-heading" style="margin-top:0px; text-transform: uppercase; font-size: 18px;">{l s='Product customization'}</h3>
								...
								<li class="customizationUploadLine{if $field.required} required{/if}">{assign var='key' value='pictures_'|cat:$product->id|cat:'_'|cat:$field.id_customization_field}
									...
									<div class="customizationUploadBrowse form-group">
										<label class="customizationUploadBrowseDescription">
											...
											{/if}
											{if $field.required}<span style="color:#e62e04">*</span>{/if}
										</label>
		...
		<p class="clear required"><span style="color:#e62e04">*</span> {l s='required fields'}</p>
	</section>
	<!--end Customization -->
	{/if}
	{if !$content_only && isset($accessories) && $accessories}
		<!--Accessories -->
		<section class="page-product-box">
