   ...
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
      	...
      	<div itemprop="articleBody">
            ...
            {$catOptions.slug = $cat_link_rewrite}
	               ...
	               {if $smartshowauthorstyle != 0}{$firstname} {$lastname}
	               {else}{$lastname} {$firstname}{/if}
	           		</span>&nbsp;
	           		<i class="fa fa-calendar"></i>&nbsp;
	           		<span itemprop="dateCreated">
	           		{$created|date_format}</span>{/if}&nbsp;&nbsp;
	           		<i class="fa fa-tags"></i>&nbsp;
	           		<span itemprop="articleSection">
	           		<a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}">{$title_category}</a></span> &nbsp;

	           		<i class="fa fa-comments"></i>&nbsp; {if $countcomment != ''}{$countcomment}{else}{l s='0' mod='smartblog'}{/if}{l s=' Comments' mod='smartblog'}</span>
