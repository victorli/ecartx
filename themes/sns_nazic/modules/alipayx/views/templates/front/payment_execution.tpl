...
{else}
        ...
        <p class="cart_navigation clearfix" id="cart_navigation">
        	...
        	<a class="btnsns" href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" type="button">

                <span><i class="icon-chevron-left"></i>{l s='Other payment methods' mod='alipayx'}</span>
