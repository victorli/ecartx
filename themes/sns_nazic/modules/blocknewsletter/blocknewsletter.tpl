...
<div class="block-subscribe-content">
    <form action="{$link->getPageLink('index')|escape:'html':'UTF-8'}" method="post">	
		...
		<!-- <p>{l s='Subscribe To Our Newsletter!' mod='blocknewsletter'}</p> -->
        <div class="subscribe_form form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}">
    		<div class="inner">
                ...
                <button type="submit" name="submitNewsletter" class="btn btn-default button button-small" data-icon="&#xe010;"></button>
