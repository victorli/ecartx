...
<ul class="footer_links clearfix">
	...
	<li><a class="btn btn-default button button-small" href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-chevron-left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
