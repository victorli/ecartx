...
<div class="mycart mini-cart{if $PS_CATALOG_MODE} header_user_catalog{/if} header-block">
	<div class="tongle" title="{l s='View my shopping cart'}">
		<i data-icon="&#xe013;"></i>
		{l s='Cart:' mod='blockcart'}
		<span class="number-item ajax_cart_quantity"> {$cart_qties} </span> <span class="item-cart">{l s='item' mod='blockcart'}</span>
	</div>
	<div class="content ">
			...
			<div class="shopping_cart">
				{if !$PS_CATALOG_MODE}
					<div class="cart_block exclusive">
						{* <p class="block-subtitle">{l s='Recently added item(s)' mod='blockcart'}</p> *}
						<div class="block_content">
							...
							<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
								...
								<div class="bottom-action actions">
									...
									<a class="btn btn-default button button-small" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Go to cart' mod='blockcart'}" rel="nofollow">
										{l s='Go to cart' mod='blockcart'}
									</a>
									<a class="btn btn-default button button-small" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
...
{else}
	<div class="shopping_cart">
		<a class="tongle" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
		...
		{if !$PS_CATALOG_MODE}
			<div class="cart_block block exclusive">
				<p class="block-subtitle">
		        	{l s='Recently added item(s)' mod='blockcart'}
		        </p>
				<div class="block_content">
					<!-- block list of products -->
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
