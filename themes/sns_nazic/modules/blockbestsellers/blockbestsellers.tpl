...
<div id="best-sellers_block_right" class="block products_block">
	...
	{if $best_sellers && $best_sellers|@count > 0}
		...
		<div class="lnk">
        	<a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='blockbestsellers'}"  class="btn btn-default button button-small"><span>{l s='All best sellers' mod='blockbestsellers'}</span></a>
        </div>
	{else}
