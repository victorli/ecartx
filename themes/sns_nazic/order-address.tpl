...
<div class="addresses clearfix">
	<div class="row">
		<div class="col-xs-12 {if $use_invoice_address} col-sm-6 {else} col-sm-12 {/if}" {if !$use_invoice_address} style="margin-bottom:5px;"{/if}>
			...
			<p class="checkbox addressesAreEquals"{if $cart->isVirtualCart()  || !$use_invoice_address} style="display:none;"{/if}>
		...
		<div class="col-xs-12 col-sm-6"  {if !$use_invoice_address} style="display:none;"{/if}>
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				<a href="{$link->getPageLink($back_order_page, true, NULL, "step=0{if $back}&back={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btnsns">
					<i class="fa fa-chevron-left"></i>
					{l s='Continue Shopping'}
				</a>
				<button type="submit" name="processAddress" class="btnsns pull-right">
