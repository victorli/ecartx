		...
		*}
		...
		<div class="item-info col-sm-6">
			...
			<div class="discount_productdeal">
				{if $product.specific_prices.reduction_type == 'percentage'} {l s = 'Discount'}  {$product.specific_prices.reduction * 100}% {/if},  {l s = 'You save'} {convertPrice price=($product.price_without_reduction - $product.price)}
			</div>
