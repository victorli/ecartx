...
<div itemscope itemtype="http://schema.org/Product">
	...
	<div class="primary_block">
		...
		<div id="product_view_primary_block" class="primary_block row-img row">
			...
			{else}
			<div class="product-img-box col-xs-5 col-sm-5 col-md-5">
			{/if}
				<!-- product img-->
				<div id="image-block" class="clearfix">
					
					{*<!-- <div class="badges">
						{if $product->new}<span class="ico-product ico-new">{l s='New'}</span>{/if}
						{if $product->on_sale}
							<span class="ico-product ico-sale">{l s='Sale!'}</span>
						{elseif $product->specificPrice && $product->specificPrice.reduction && $productPriceWithoutReduction > $productPrice}
							<span class="ico-product ico-sale">{l s='Reduced price!'}</span>
						{/if}
					</div> -->*}
							...
							{if isset($images)}
								{foreach from=$images item=image name=thumbnails}
									...
									<li id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
										<a{if $jqZoomEnabled && $have_image && !$content_only} 
											href="javascript:void(0);" 
											rel="{literal}{{/literal}gallery: 'gal1', smallimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'large_default')|escape:'html':'UTF-8'}',largeimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}'{literal}}{/literal}"{else} href="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}"	
											data-fancybox-group="other-views" 
											class="fancybox{if $image.id_image == $cover.id_image} shown{/if}"{/if} 
											title="{$imageTitle}">
			...
			{else}
			<div class="product-shop col-xs-7 col-sm-7 col-md-7">
			{/if}
				...
				*}
					...
					<!-- pb-right-column-->
						...
						<!-- add to cart form-->
							...
							{if $SNS_NAZ_ADDTHISBTN}
							<div class="block-addthis">
			                	<!-- AddThis Button BEGIN -->
			                	{*
									Sharing Buttons:  <div class="addthis_sharing_toolbox"></div>
									Original Sharing Buttons: <div class="addthis_native_toolbox"></div>
			                	*}
		...
		<div id="sns_tab_products" class="product-collateral clearfix">
			<ul class="nav-tabs gfont">
				{if $product->description}
					<li><a href="#sns_tab_info" data-toggle="tab">{l s='More info'}</a></li>
				{/if}
				...
				{/if}
				{$HOOK_PRODUCT_TAB}
				{if $SNS_NAZ_CUSTOMTAB}
					<li><a href="#sns_tab_custom" data-toggle="tab">{$SNS_NAZ_CUSTOMTAB_TITLE}</a></li>
				{/if}
			</ul>
			<div class="tab-content">
				...
				{if $SNS_NAZ_CUSTOMTAB}
					<section id="sns_tab_custom" class="page-product-box tab-pane fade">{$SNS_NAZ_CUSTOMTAB_CONTENT}</section>
				{/if}
			</div><!--end .tab-content -->
